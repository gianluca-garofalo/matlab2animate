...
% Removed the box around the equations added by matlab2tikz
matlab2animate( 'make', 'adjust', 'old',...
    {'font=\color{white!15!black}'  'draw=black'}, 'new',...
    {'fill=none'                    'draw=none'} );
% matlab2tikz does not respect the axes positions. Probably the problem can
% be solved using subplot
matlab2animate( 'make', 'adjust', 'old',...
